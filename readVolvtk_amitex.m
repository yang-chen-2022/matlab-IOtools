function [ X,spacing,fieldnames,typeMAT ] = readVolvtk_amitex( varargin )
...
% 21/03/2016 Y.Chen
% 09/09/2016 Y.Chen
% 16/04/2018 Y.Chen (remove the "permute")
        ...
        if i==n(i_chmp)
           ...
           % -----------------------------------
            ...
            for ibloc=1:nblocs
                ...
                X{i_chmp}(:,:,i1:i2)=reshape(B,nx,ny,inc);
                disp(num2str([ibloc,i1,i2,inc]))
                if over==1; break; end
            end
